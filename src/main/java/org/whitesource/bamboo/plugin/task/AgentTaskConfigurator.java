...
import static org.whitesource.bamboo.plugin.Constants.DEFAULT_CHECK_POLICIES;
import static org.whitesource.bamboo.plugin.Constants.DEFAULT_FILES_INCLUDES_PATTERN;
...
public class AgentTaskConfigurator extends AbstractTaskConfigurator implements TaskRequirementSupport {
	...
	public void populateContextForCreate(@NotNull final Map<String, Object> context) {
		...
		context.put(SERVICE_URL_KEYWORD, Constants.DEFAULT_SERVICE_URL);
