...
public class Constants {
	...
	public static final Set<String> FIELD_COLLECTION = ImmutableSet
	        ...
	        .add(API_KEY, CHECK_POLICIES, FORCE_UPDATE, PROJECT_TYPE, PRODUCT_TOKEN,PROJECT_TOKEN, PRODUCT_VERSION,MODULE_TOKENS, MODULES_INCLUDE_PATTERN,
	                MODULES_EXCLUDE_PATTERN, FILES_INCLUDE_PATTERN, FAIL_ON_ERROR, FAIL_ON_CONNECTION_ERROR, CONNECTION_RETRIES, FILES_EXCLUDE_PATTERN,
					IGNORE_POM,SERVICE_URL_KEYWORD, PROXY_SETTINGS, PROXY_PORT, PROXY_HOST, PROXY_PASSWORD, PROXY_USER_NAME, BAMBOO_SYSTEM_PROPERTIES,
					MAVEN_PATH, USER_KEY).build();
	...
	public static final int FIND_SUCCESS_MESSAGE_IN_LAST = SystemProperty.FIND_SUCCESS_MESSAGE_IN_LAST.getValue(80);
